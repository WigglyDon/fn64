...
- Current direct workflow: [MASTER_DIRECT_WORKFLOW.md](process/MASTER_DIRECT_WORKFLOW.md)
- Historical Worker worktree provisioning: [WORKTREE_PROVISIONING.md](process/WORKTREE_PROVISIONING.md)
