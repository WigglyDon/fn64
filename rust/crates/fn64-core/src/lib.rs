...
pub use rsp::{
    ...
    MachineRspBgezalSource, MachineRspBreakSource, MachineRspControlRegister,
    ...
    RSP_LOCAL_ADDRESS_MASK, RSP_SCALAR_ADDI_OPCODE, RSP_SCALAR_BGEZAL_SELECTOR,
    ...
    RSP_VECTOR_VADDC_FUNCTION, RSP_VECTOR_VSUB_FUNCTION,
};
pub use si::{
