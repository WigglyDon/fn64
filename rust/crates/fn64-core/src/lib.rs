...
pub use rsp::{
    ...
    MachineRspMfc0ResultSource, MachineRspScalarLwSource, MachineRspScalarRegisterSource,
    ...
    RSP_LOCAL_ADDRESS_MASK, RSP_SCALAR_LW_BYTE_COUNT, RSP_SCALAR_LW_OPCODE,
    RSP_SCALAR_REGISTER_COUNT, RSP_VECTOR_LOAD_OPCODE, RSP_VECTOR_LQV_SUBOPCODE,
    RSP_VECTOR_REGISTER_BYTE_COUNT, RSP_VECTOR_REGISTER_COUNT,
};
pub use si::{
