...
pub use machine::{
    ...
    MachineSpDmemInstructionProvenance, MachineSpDmemLoadWordProvenance, MachineStepCadencePlan,
    ...
    MachineStepUnsupportedInstructionCategory, MACHINE_CARTRIDGE_BOOTSTRAP_EXECUTION_PC,
