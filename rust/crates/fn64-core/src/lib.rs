...
pub use rsp::{
    ...
    RSP_COP0_OPCODE, RSP_COP0_SP_DRAM_ADDRESS_INDEX, RSP_COP0_SP_MEMORY_ADDRESS_INDEX,
    RSP_COP0_SP_READ_LENGTH_INDEX, RSP_COP0_SP_SEMAPHORE_INDEX, RSP_INSTRUCTION_ALIGNMENT_MASK,
    RSP_LOCAL_ADDRESS_MASK, RSP_SCALAR_LUI_OPCODE, RSP_SCALAR_LW_BYTE_COUNT, RSP_SCALAR_LW_OPCODE,
    RSP_SCALAR_REGISTER_COUNT, RSP_SCALAR_XORI_OPCODE, RSP_VECTOR_LOAD_OPCODE,
