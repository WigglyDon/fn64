...
pub use rsp::{
    ...
    RSP_COP0_SP_DMA_BUSY_INDEX, RSP_COP0_SP_DMA_FULL_INDEX, RSP_COP0_SP_DRAM_ADDRESS_INDEX,
    RSP_COP0_SP_MEMORY_ADDRESS_INDEX, RSP_COP0_SP_READ_LENGTH_INDEX, RSP_COP0_SP_SEMAPHORE_INDEX,
    RSP_INSTRUCTION_ALIGNMENT_MASK, RSP_LOCAL_ADDRESS_MASK, RSP_SCALAR_ADDI_OPCODE,
