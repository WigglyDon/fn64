...
pub use cpu::{
    ...
    MachineCop1Lwc1Provenance, MachinePrimaryCacheCleanRoomHleSource,
...
pub use machine::{
    ...
    MachineLwc1Rejection, MachineLwc1RejectionReason, MachineMtc0Destination, MachineMtc0Rejection,
