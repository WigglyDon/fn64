...
returns the token. Break word `0x0000000D` at local `0x09C` then rejects
atomically without changing Dpc, SP halt/broke, MI, or any other Machine state.
